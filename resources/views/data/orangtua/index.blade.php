            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
                        <h1 class="text-sm font-medium dark:text-white">Data / Orang Tua</h1>
                    </div>
                </div>
            </section>
        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        <div
                            ...
                            <div
                                ...
                                <a href="{{ url('/data/orangtua/tambah') }}" type="button"
                                    ...
                                    @foreach ($orangtua as $o)
                                        <tr class="border-b dark:border-gray-700">
                                            <td scope="row"
                                                ...
                                                {{ $o->nama }}</td>
                                            <td class="px-4 py-3">{{ $o->nik }}</td>
                                            <td class="px-4 py-3">{{ $o->jenis_kelamin }}</td>
                                            <td class="px-4 py-3">{{ $o->pendidikan }}</td>
                                            <td class="px-4 py-3">{{ $o->jenis_pekerjaan }}</td>
                                            <td class="px-4 py-3 flex items-center justify-end">
                                                <button id="apple-imac-27-dropdown-button"
                                                    data-dropdown-toggle="{{ $o->nik }}"
                                                ...
                                                <div id="{{ $o->nik }}"
                                                    ...
                                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                        ...
                                                        <li>
                                                            <a href="{{ url('/data/orangtua/detail/' . $o->nik) }}"
                                                    ...
                                                    <div class="py-1">
                                                        <a type="button" data-modal-target="deleteModal"
                                                            data-modal-toggle="deleteModal" data-nik="{{ $o->nik }}"
                        ...
                        {{ $orangtua->links('vendor.pagination.tailwind') }}
                    </div>
                </div>
            </section>
        </div>
    ...
    <script>
        document.querySelectorAll('[data-modal-toggle="deleteModal"]').forEach(link => {
            link.addEventListener('click', (event) => {
                ...
                confirmDeleteForm.action = `/data/orangtua/hapus/${nik}`;
            });
        });
    </script>
