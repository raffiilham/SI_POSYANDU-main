            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div
                        ...
                        <h1 class="text-sm font-medium dark:text-white">Data / Orang Tua / Tambah</h1>
                ...
                <div class="mx-auto max-w-screen-xl">
                    <div class="relative overflow-hidden">
                        <div class="flex items-center p-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"
                            ...
                            <div>Form ini hanya digunakan untuk menginputkan data orang tua yang belum sama sekali
                                didaftarkan pada sistem.</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
                        ...
                        <form action="{{ url('/data/orangtua/prosesTambahOrangTua') }}" method="POST">
                            @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('nik').addEventListener('change', function() {
                var nik = this.value;
                if (nik) {
                    fetch(`/data/orangtua/getPendudukByNikOT/${nik}`)
