            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div
                        ...
                        <h1 class="text-sm font-medium dark:text-white">Data / Penduduk / Tambah</h1>
            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Penduduk Baru</h2>
                        <form action="{{ url('/data/penduduk/prosesTambahPenduduk') }}" method="POST">
                            @csrf
