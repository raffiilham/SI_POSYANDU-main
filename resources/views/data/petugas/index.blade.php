            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
                        <h1 class="text-sm font-medium dark:text-white">Data / Petugas</h1>
                    </div>
                </div>
            </section>
        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        <div
                            ...
                            <div
                                ...
                                <a href="{{ url('/data/petugas/tambah') }}" type="button"
                            ...
                            <table id="dataTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Jenis Pekerjaan</th>
                                ...
                                <tbody>
                                    @foreach ($petugas as $p)
                                        <tr class="border-b dark:border-gray-700">
                                            ...
                                            <td class="px-4 py-3">{{ $p->jenis_pekerjaan }}</td>
                                            <td class="px-4 py-3 flex items-center justify-end">
                                                <button id="apple-imac-27-dropdown-button"
                                                    data-dropdown-toggle="{{ $p->nik }}"
                                                ...
                                                <div id="{{ $p->nik }}"
                                                    ...
                                                    <div class="py-1">
                                                        <a type="button" data-modal-target="deleteModal"
                                                            data-modal-toggle="deleteModal" data-nik="{{ $p->nik }}"
                                                            class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white cursor-pointer">Nonaktifkan</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <div id="deleteModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md h-auto">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <p class="mb-4 text-gray-500 dark:text-gray-300">Apakah Anda yakin ingin menonaktifkan petugas ini?</p>
    ...
    <script>
        document.querySelectorAll('[data-modal-toggle="deleteModal"]').forEach(link => {
            link.addEventListener('click', (event) => {
                ...
                confirmDeleteForm.action = `/data/petugas/hapus/${nik}`;
            });
        });
    </script>
