            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div
                        ...
                        <h1 class="text-sm font-medium dark:text-white">Imunisasi / Tambah</h1>
            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Imunisasi Baru</h2>
                        <form action="{{ url('/imunisasi/prosesTambah') }}" method="POST">
                            @csrf
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="text" name="imunisasi" id="imunisasi"
                                        ...
                                        placeholder="Imunisasi" required="">
                                </div>
                                <div class="w-full">
                                    <label for="vitamin"
