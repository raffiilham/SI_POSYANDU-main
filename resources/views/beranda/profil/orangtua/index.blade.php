            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div
                        ...
                        <h1 class="text-sm font-medium dark:text-white">Beranda / Profil / Orang Tua</h1>
                        <a href="{{ url('/beranda') }}"
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="w-full">
                                <dl>
                                    ...
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                        {{ $penduduks->jenis_kelamin }}</dd>
                                </dl>
                            </div>
                            <div class="w-full">
                                <dl>
                                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Tempat Lahir
                                    </dt>
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                        {{ $penduduks->tempat_lahir }}</dd>
                                </dl>
                            </div>
                            <div class="w-full">
                                <dl>
                                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Tanggal Lahir
                                    </dt>
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400 format-tanggal">
                                        {{ $penduduks->tanggal_lahir }}</dd>
                                </dl>
                            </div>
                            <div class="w-full">
                                <dl>
                            ...
                            <div class="w-full">
                                <dl>
                                    ...
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                        {{ $penduduks->jenis_pekerjaan }}
                                    </dd>
                                </dl>
                            </div>
                            <div class="w-full">
                                <dl>
                                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Golongan Darah
                                    </dt>
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                        {{ $penduduks->golongan_darah }}</dd>
                                </dl>
                            </div>
                            <div class="w-full">
                                <dl>
                                    ...
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                        {{ $penduduks->status_perkawinan }}</dd>
                                </dl>
                            </div>
                            <div class="w-full">
                                <dl>
                                    ...
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400 format-tanggal">
                                        {{ $penduduks->tanggal_perkawinan }}</dd>
                                </dl>
                            </div>
                            <div class="w-full">
                                <dl>
                                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Status
                                        ...
                                        Dalam Keluarga</dt>
                                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                                        {{ $penduduks->status_hubungan_keluarga }}
                                    </dd>
                                </dl>
                            </div>
                            <div class="w-full">
