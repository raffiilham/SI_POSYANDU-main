...
@section('title')
    <title>Pertumbuhan | Tambah</title>
@endsection
            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div
                        ...
                        <h1 class="text-sm font-medium dark:text-white">Pertumbuhan / Tambah</h1>
            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Pertumbuhan Baru</h2>
                        <form action="{{ url('/pertumbuhan/prosesTambah') }}" method="POST">
                            @csrf
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                <div class="w-full sm:col-span-2">
                                    ...
                                    <select id="nik" name="nik"
                                        ...
                                        @foreach ($anak as $a)
                                            <option value="{{ $a->nik }}">{{ $a->nik }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="w-full">
